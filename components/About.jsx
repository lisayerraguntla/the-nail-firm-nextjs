...
const highlights = [
  {
    ...
    text: 'The Nail Firm name comes from me studying law. A little clever, a little dramatic, very on brand for me.',
  },
  {
    icon: Sparkles,
    title: 'Uni hobby turned love',
    text: 'I started doing nails as something to do at university, and it quickly became a creative service I genuinely love.',
  },
  {
    icon: UserRound,
    title: 'Affordable by choice',
    text: 'I keep my prices accessible because I think everyone deserves to feel pretty without breaking the bank.',
  },
  {
    icon: Music,
    title: 'Your appointment, your vibe',
    text: 'You can chat, laugh, share the tea, request a silent service, or tell me to swap the playlist to your favourites.',
  },
];
    ...
    <section id="about" className="salon-surface px-4 py-24 md:px-8">
      <div className="relative mx-auto max-w-7xl">
        <div className="grid gap-10 lg:grid-cols-[0.92fr_1.08fr] lg:items-stretch">
          <div className="relative overflow-hidden rounded-4xl border border-champagne/15 bg-[#070706]/78 p-7 shadow-2xl shadow-black/25 md:p-10">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <div className="rounded-3xl border border-champagne/20 bg-champagne/10 p-6 sm:col-span-2">
              ...
              <p className="mt-3 leading-7 text-white/72">
                Bring me the dark humour, the tea, the life updates, or total silence. If my music is not your vibe, just say the word and your favourites can take over.
              </p>
            </div>
          </div>
        </div>
